/**
 *  @fileOverview ImpactJS splash loader screen.
 *  @see {@link https://github.com/phoboslab/impact-splash-loader} for original source code.
 */
    ...
    ig.SplashLoader = ig.Loader.extend({
        ...
        draw: function() {
            ...
            ctx.save();
                ...
                this.drawPaths('rgb(255, 255, 255)', ig.SplashLoader.PATHS_IMPACT);

                var comet = ig.SplashLoader.PATHS_COMET;
        ...
        drawPaths: function(color, paths) {
            ...
            for(var i = 0; i < paths.length; i += 2) {
                ctx[ig.SplashLoader.OPS[paths[i]]].apply(ctx, paths[i + 1]);
            }
        }
    });
