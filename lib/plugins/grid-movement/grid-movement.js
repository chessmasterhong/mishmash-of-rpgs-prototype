...
.defines(function() {
    ...
    ig.global.GridMovement = ig.Class.extend({
        ...
        getCurrentTile: function() {
            var tileX = this.entity.pos.x / ig.global.TILESIZE,
                tileY = this.entity.pos.y / ig.global.TILESIZE;
        ...
        snapToTile: function(x, y) {
            this.entity.pos.x = x * ig.global.TILESIZE;
            this.entity.pos.y = y * ig.global.TILESIZE;
        },

        justReachedDestination: function() {
            var destinationX = this.destination.x * ig.global.TILESIZE,
                destinationY = this.destination.y * ig.global.TILESIZE;
        ...
        setVelocityByTile: function(tileX, tileY, velocity) {
            var tileCenterX = tileX * ig.global.TILESIZE + ig.global.TILESIZE / 2,
                tileCenterY = tileY * ig.global.TILESIZE + ig.global.TILESIZE / 2,
